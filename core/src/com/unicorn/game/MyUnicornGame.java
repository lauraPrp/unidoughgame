...
public class MyUnicornGame extends ApplicationAdapter {
	...
	private SpriteBatch batchPoint;
	...
	//	rainMusic.play();
		...
		point =0;
		points= (String) Integer.toString(point);
		batchPoint = new SpriteBatch();

		batchPoint.begin();
		//font.draw(batchPoint, points, 650, 450);
	}
	...
	public void render() {
		...
		for (Iterator<Rectangle> iter = raindrops.iterator(); iter.hasNext(); ) {
			...
			if(raindrop.overlaps(bucket)) {
				...
				point++;
				points= (String) Integer.toString(point);
				CharSequence chrseq = new CharSequence() {
					@Override
					public int length() {
						return 0;
					}
